...
var _felicefelicis$portfolio$Main$backgroundGenerator = A2(_mgold$elm_random_pcg$Random_Pcg$int, 1, 3);
var _felicefelicis$portfolio$Main$PortfolioItem = F5(
	function (a, b, c, d, e) {
		return {thumbnail: a, zoom: b, link: c, descriptionProjet: d, over: e};
	});
var _felicefelicis$portfolio$Main$model = {
	backgroundImage: 1,
	portfolioItems: _elm_lang$core$Array$fromList(
		{
			ctor: '::',
			_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/final_pad.gif', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, 'Paddy Mimbulus Mimbletonia', false),
			_1: {
				ctor: '::',
				_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/Lockhart_hogwarts_v1.gif', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
				_1: {
					ctor: '::',
					_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/PA_elixir1.jpg', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
					_1: {
						ctor: '::',
						_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/equipe_elixir1.jpg', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
						_1: {
							ctor: '::',
							_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/zoomcours_elixir1.jpg', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
							_1: {
								ctor: '::',
								_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/theEndBegins1.gif', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
								_1: {
									ctor: '::',
									_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/abistiel9.png', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
									_1: {
										ctor: '::',
										_0: A5(_felicefelicis$portfolio$Main$PortfolioItem, 'images/portfolio/NEW_BANN_MM_ENCOURS5.gif', _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, '', false),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _felicefelicis$portfolio$Main$updatePortfolioItemOver = F3(
	function (index, over, portfolioItems) {
		var mItem = A2(_elm_lang$core$Array$get, index, _felicefelicis$portfolio$Main$model.portfolioItems);
		var _p0 = mItem;
		if (_p0.ctor === 'Just') {
			return A3(
				...
				_elm_lang$core$Native_Utils.update(
					_p0._0,
					{over: over}),
				_felicefelicis$portfolio$Main$model.portfolioItems);
		} else {
			return _felicefelicis$portfolio$Main$model.portfolioItems;
		}
	});
var _felicefelicis$portfolio$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'SetBgImage':
			...
			case 'OverItem':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							portfolioItems: A3(_felicefelicis$portfolio$Main$updatePortfolioItemOver, _p1._0, true, model.portfolioItems)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							portfolioItems: A3(_felicefelicis$portfolio$Main$updatePortfolioItemOver, _p1._0, false, model.portfolioItems)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _felicefelicis$portfolio$Main$Model = F2(
	function (a, b) {
		return {backgroundImage: a, portfolioItems: b};
	});
var _felicefelicis$portfolio$Main$OutItem = function (a) {
	return {ctor: 'OutItem', _0: a};
};
var _felicefelicis$portfolio$Main$OverItem = function (a) {
	return {ctor: 'OverItem', _0: a};
};
var _felicefelicis$portfolio$Main$viewPortfolioItem = F2(
	function (index, item) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Events$onMouseEnter(
					_felicefelicis$portfolio$Main$OverItem(index)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onMouseLeave(
						_felicefelicis$portfolio$Main$OutItem(index)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('overItemPortfolio'),
						_1: {
							ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('www'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href(
												A2(_elm_lang$core$Maybe$withDefault, '#', item.link)),
											_1: {ctor: '[]'}
										}
									},
									{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('zoom'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Maybe$withDefault, '#', item.zoom)),
												_1: {ctor: '[]'}
											}
										},
										{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('descriptionProjet'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(item.descriptionProjet),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(item.thumbnail),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
...
var _felicefelicis$portfolio$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('navigationPrincipale'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('#competence'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('COMPÉTENCES'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('#joindre'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('À PROPOS'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('entete'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_1: A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(model.backgroundImage),
												'.jpeg)'))
									},
									_1: {ctor: '[]'}
								}),
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('nom'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('KATHLEEN'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('BLACKBURN'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('portfolio'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Parce qu\'il faut parfois savoir être showoff'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('sectionTitre'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('conteneurProjet'),
												_1: {ctor: '[]'}
											},
											_elm_lang$core$Array$toList(
												A2(_elm_lang$core$Array$indexedMap, _felicefelicis$portfolio$Main$viewPortfolioItem, model.portfolioItems))),
										_1: {ctor: '[]'}
									}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('competence'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('J\'ai des skills aussi'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('joindre'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Ça serait pertinent de pouvoir me rejoindre n\'est-ce pas?'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Me joindre'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _felicefelicis$portfolio$Main$SetBgImage = function (a) {
	return {ctor: 'SetBgImage', _0: a};
};
var _felicefelicis$portfolio$Main$init = {
	ctor: '_Tuple2',
	_0: _felicefelicis$portfolio$Main$model,
	_1: A2(_mgold$elm_random_pcg$Random_Pcg$generate, _felicefelicis$portfolio$Main$SetBgImage, _felicefelicis$portfolio$Main$backgroundGenerator)
};
var _felicefelicis$portfolio$Main$main = _elm_lang$html$Html$program(
	{
		init: _felicefelicis$portfolio$Main$init,
		view: _felicefelicis$portfolio$Main$view,
		update: _felicefelicis$portfolio$Main$update,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _felicefelicis$portfolio$Main$main !== 'undefined') {
    _felicefelicis$portfolio$Main$main(Elm['Main'], 'Main', undefined);
}
